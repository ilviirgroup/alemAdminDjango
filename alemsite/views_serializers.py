...
from .models import Brand, Products, Category, Color, Gender, Size, Status, Subcategory, Update, Messages, Orders
...
from .serializers import MessageSerializer, FavoritesSerializer, UpdateSerializer, UserAlemSerializer
...
class ApiRoot(generics.GenericAPIView):
    ...
    def get(self, request, *args, **kwargs):
        return Response({
            ...
            '9-update': reverse(UpdateList.name, request=request),
